...
fidibus-ilocus-summary.py  --workdir=data --outfmt=tsv \
	Scer Cele Crei Mtru Agam Dmel Xtro Drer Mmus Hsap Vcar Pdom Dpul Mvit  > tables/ilocus-delta500-summary.tsv
fidibus-pilocus-summary.py --workdir=data --outfmt=tsv \
	Scer Cele Crei Mtru Agam Dmel Xtro Drer Mmus Hsap Vcar Pdom Dpul Mvit  > tables/pilocus-delta500-summary.tsv
fidibus-milocus-summary.py --workdir=data --outfmt=tsv \
	Scer Cele Crei Mtru Agam Dmel Xtro Drer Mmus Hsap Vcar Pdom Dpul Mvit  > tables/milocus-delta500-summary.tsv
